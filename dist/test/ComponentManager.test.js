...
test('Subscribing to an entity that is already subscribed should update the existing entity', () => {
    ...
    expect((_a = transformComponent.sparseArray[id]) === null || _a === void 0 ? void 0 : _a.position.x).toBe(data.position.x);
    expect((_b = transformComponent.sparseArray[id]) === null || _b === void 0 ? void 0 : _b.position.y).toBe(data.position.y);
    componentManager.subscribeEntity(id, [newData], transformComponent);
    expect((_c = transformComponent.sparseArray[id]) === null || _c === void 0 ? void 0 : _c.position.x).toBe(newData.position.x);
    expect((_d = transformComponent.sparseArray[id]) === null || _d === void 0 ? void 0 : _d.position.y).toBe(newData.position.y);
});
...
//# sourceMappingURL=ComponentManager.test.js.map